...

{
...

    {
        ...
        {
            if (n == 0) {
                int k = rand() % 3; if (k == 0 || k == 1) { a[i][j] = 2; }
...

{
...

    {
        ...
        if (over) {
            if (key == 89 || key == 121) { rsgm(); continue; }
...

        {
...

            {
...

                {
                    ...
                    a[i][k + 1] = a[i][j]; if ((k + 1) != j) { a[i][j] = 0; ifnum = 1; }
...

        {
...

            {
                if (a[k][i] == a[j][i]) {
                    ...
                    a[k + 1][i] = a[j][i]; if ((k + 1) != j) { a[j][i] = 0; ifnum = 1; }
